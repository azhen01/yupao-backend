...
import com.zzlearning.yupao.enums.TeamStatusEnum;
import com.zzlearning.yupao.mapper.TeamMapper;
...
import com.zzlearning.yupao.model.domain.vo.UserVO;
    ...
    public boolean quitTeam(TeamQuitRequest teamQuitRequest, User loginUser) {
        ...
        if (teamHasJoinNum == 1) {
            ...
            if (team.getUserId() == userId) {
                ...
                QueryWrapper<UserTeam> userTeamQueryWrapper = new QueryWrapper<>();
                userTeamQueryWrapper.eq("teamId", teamId);
                userTeamQueryWrapper.last("order by id as asc limit 2");
